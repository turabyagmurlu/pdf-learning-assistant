...
/* Ş1 — iOS ana ekran ikonu (kose yuvarlatmayi iOS yapar). */
export default function AppleIcon() {
  return new ImageResponse(
    (
      <div style={{ width: 180, height: 180, display: "flex", position: "relative", background: "#f6b45c" }}>
        <svg width="180" height="180" viewBox="0 0 200 200" style={{ position: "absolute", top: 0, left: 0 }}>
        ...
        <div style={{
          position: "absolute", left: 0, right: 0, top: 150, display: "flex", justifyContent: "center",
          fontSize: 22, fontWeight: 700, color: "#ffe1a8", letterSpacing: 5, fontFamily: "serif",
        }}>TY</div>
      </div>
    ),
    { ...size },
