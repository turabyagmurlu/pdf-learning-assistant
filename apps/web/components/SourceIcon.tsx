...
/** Kaynak turune gore simge rengi (yalniz ikon; lib/palette TYPE_ICON_COLOR). */
export function sourceColor(kind?: string | null) {
  return typeIconColor(kind);
}

/**
 * Tur icin acik ton zemin (atif cipi, kucuk avatar; karanlik modda saydam).
 * TS-6: kart KAPAGINDA kullanilmaz — kapak rengi yalniz konuyu gosterir (lib/palette topicColor / TOPIC_NEUTRAL).
 */
